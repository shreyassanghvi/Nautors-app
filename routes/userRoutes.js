...
router
    ...
    .patch(authController.protect, authController.resitrictTo('admin'), controller.updateUserById)
    .delete(authController.protect, authController.resitrictTo('admin'), controller.deleteUserById);
